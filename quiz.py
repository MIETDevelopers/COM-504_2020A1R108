...
class Quiz:
	...
	def display_title(self):
		...
		title = Label(gui, text="Diyva QUIZ",
...
gui.title("DivyaJot Kour")

# get the data from the json file
with open('C:\\Users\\Best Price computers\\OneDrive\\Desktop\\qiiz\\data.json') as f:
	data = json.load(f)
